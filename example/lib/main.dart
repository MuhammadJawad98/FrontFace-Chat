...
const _arabicStrings = FrontFaceChatStrings(
  ...
  audioAttachment: 'مرفق صوتي',
  videoAttachment: 'مرفق فيديو',
  ...
  permissionCameraBody:
      'يحتاج FrontFace إلى الكاميرا لالتقاط صورة أو فيديو للدعم.',
  ...
  permissionVideosBody: 'يحتاج FrontFace إلى الفيديو لإرفاق مقطع.',
